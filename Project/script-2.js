...
//ollisionCanvas.width = window.innerWidth;
//collisionCanvas.height = window.innerHeight;
const gameCanvas = document.querySelector('.game-canvas');
canvas.width = gameCanvas.clientWidth;
canvas.height = gameCanvas.clientHeight;
collisionCanvas.width = gameCanvas.clientWidth;
collisionCanvas.height = gameCanvas.clientHeight;
...
// Objects (Ravens, Explosion, Particles)
