// this uses enum to define a set of neamed constants
export const states = {
    STANDING_LEFT: 0,
    STANDING_RIGHT: 1,
    SITTING_LEFT: 2,
...
// 'extends' is a keyword used to create a child class
// child class (also called 'sub' class)
export class StandingLeft extends State {
    constructor(player) {
        /* We can use 'super' keyword in child classes to access and call methods on object's parent */
        super('STANDING LEFT');
        this.player = player;
    }
    enter() {
...
export class JumpingLeft extends State {
    ...
    handleInput(input) {
        ...
        else if (this.player.velocityY > this.player.gravity) this.player.setState(states.FALLING_LEFT);
    }
}
...
export class JumpingRight extends State {
    ...
    handleInput(input) {
        ...
        else if (this.player.velocityY > this.player.gravity) this.player.setState(states.FALLING_RIGHT);
    }
}
