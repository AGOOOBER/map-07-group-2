...
export class Running extends State {
    ...
    // while the player is in a certain state it will only react to limited number of keyboard inputs
    handleInput(input) {
        this.game.particles.push(new Dust(this.game, this.game.player.x + this.game.player.width * 0.6,
...
export class Jumping extends State {
    ...
    enter() {
        if (this.game.player.onGround()) this.game.player.velocityY -= 25;
        this.game.player.frameX = 0;
    ...
    // while the player is in a certain state it will only react to limited number of keyboard inputs
    handleInput(input) {
        if (this.game.player.velocityY > this.game.player.gravity) {
...
export class Falling extends State {
    ...
    enter() {
        if (this.game.player.onGround()) this.game.player.velocityY -= 30;
        this.game.player.frameX = 0;
        this.game.player.maxFrame = 6;
